...
if (isset($_GET['subjectid'])) {
    ...
    <div class="wrapper">
        <div>
            <form action="alnewpost.php" method="POST" enctype="multipart/form-data">
...
if (isset($_POST['subid'])){
    ...
    if($uploadstatus==1){
        ...
        {
            $sql="insert into m_post (tittle,description,link,path,subjectid) values ('$tittle','$description','$link','$target_file','$subid')";
