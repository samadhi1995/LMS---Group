...
if ($_SESSION['role'] == "student") {
    ...
    ?> <div class="wrapper">
        <?php
        $subid=$_GET['subid'];
        $sql = "SELECT * FROM `alpost` where subjectid='$subid'";
    ...
    ?> <div class="wrapper">
        <?php
        $subid=$_GET['subid'];
        $sql = "SELECT * FROM `m_post` where subjectid='$subid'";
        $result = mysqli_query($conn, $sql);
        ?>
        <center> <a href="alnewpost.php?subjectid=<?php echo $subid; ?>" class="button2">New Post</a></center>
            ...
            <table><tr>
                    ...
                    <td style="width: 100%"><div class="post">
                            <table border="0" style="width: 100%; margin-top: 10px">
                                ...
                                <tr><td><center><a href="aledit.php?postid=<?php echo $data['postid']; ?>" class="button2"  >Edit Post</a></center></td>
