...
if (isset($_POST['reset'])) {
    ...
    $sql = "UPDATE `com_post` SET `tittle` = '$retittle', `description` = '$redescription', `link` = '$relink', `path` = '$repath' WHERE `postid` = '$postid'";
...
if (isset($_GET['postid'])) {
    $postid = $_GET['postid'];
    $sql = "SELECT * FROM `com_post` WHERE postid ='$postid'";
...
<div class="wrapper">
    <div >
        <form action="oledit.php" method="POST" >
